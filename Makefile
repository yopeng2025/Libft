...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/05/11 23:26:33 by yopeng            #+#    #+#              #
#    Updated: 2025/08/05 15:17:07 by yopeng           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
      ...
      ft_atoi.c ft_calloc.c ft_strdup.c ft_strndup.c ft_substr.c ft_strjoin.c \
      ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c \
      ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c \
      ft_printf.c ft_putchar.c ft_puthex.c ft_putnbr.c ft_putnbr_u.c \
